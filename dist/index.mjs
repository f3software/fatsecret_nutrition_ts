...
export { AuthManager, ClientCredentialsAuthenticator, DEFAULT_ENVIRONMENT, FATSECRET_PROD, FatSecretEndpoint, FatSecretMethod, FatSecretNutritionClient, FetchHttpClient, OAuth1Signer, TokenCache, createDefaultPlatformAdapters, createMemoryStorageAdapter, createNodeAdapters, createReactNativeAdapters, createWebAdapters, detectPlatform, percentEncode };
